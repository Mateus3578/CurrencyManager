...
class CriptoCurrencyCard extends StatefulWidget {
  final ThemeProvider theme;
  CriptoCurrencyCard({required this.theme});

  @override
  _CriptoCurrencyCardState createState() => _CriptoCurrencyCardState();
}

class _CriptoCurrencyCardState extends State<CriptoCurrencyCard> {
  ...
  // TODO: Mostrar ícone da moeda
  //Conexão com a api
  Future<List<QuotationModel>> _getData() async {
    ApiQuotationHelper api = ApiQuotationHelper.instance;
    String url =
        "https://economia.awesomeapi.com.br/last/BTC-BRL,LTC-BRL,ETH-BRL,XRP-BRL,DOGE-BRL";
