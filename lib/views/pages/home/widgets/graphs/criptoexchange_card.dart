...
class CriptoExchangeCard extends StatefulWidget {
  final ThemeProvider theme;
  CriptoExchangeCard({required this.theme});

  @override
  _CriptoExchangeCardState createState() => _CriptoExchangeCardState();
}

class _CriptoExchangeCardState extends State<CriptoExchangeCard> {
